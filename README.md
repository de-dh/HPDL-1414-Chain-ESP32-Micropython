...
<img align="center"  src="img/5.jpg" width="400" height="auto" />

The image shows a single HPDL-1414 display driven by an Esp32-C3-Supermini. [Rdagger's HPDL-1414 driver](https://github.com/rdagger/micropython-hpdl1414) was used to control the HPDL-1414 display. The HPDL-1414 modules require a 5V power supply. The data pins are 3.3V compatible.
